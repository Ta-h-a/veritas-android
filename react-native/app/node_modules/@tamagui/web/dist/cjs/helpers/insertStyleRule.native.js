...
var import_constants = require("@tamagui/constants"), import_helpers = require("@tamagui/helpers"), import_createVariable = require("../createVariable"), scannedCache = /* @__PURE__ */ new WeakMap(), totalSelectorsInserted = /* @__PURE__ */ new Map(), allSelectors = {}, allRules = {}, getAllSelectors = function() {
  return allSelectors;
