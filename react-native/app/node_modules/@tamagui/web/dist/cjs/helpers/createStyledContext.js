...
var import_react = __toESM(require("react")), import_mergeProps = require("./mergeProps"), import_objectIdentityKey = require("./objectIdentityKey"), import_jsx_runtime = require("react/jsx-runtime");
...
function createStyledContext(defaultValues, namespace = "") {
  ...
  const getNamespacedScope = (scope) => namespace ? `${namespace}--${scope}` : scope, Provider = ({
    ...
    const scope = getNamespacedScope(scopeIn), next = import_react.default.useMemo(() => __disableMergeDefaultValues ? values : (0, import_mergeProps.mergeProps)(defaultValues, values), [(0, import_objectIdentityKey.objectIdentityKey)(values)]);
    let ScopedProvider = OGProvider;
    return scope && (ScopedProvider = getOrCreateScopedContext(scope).Provider), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LastScopeInNamespace.Provider, { value: scope, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScopedProvider, { value: next, children }) });
