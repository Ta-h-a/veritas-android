...
var getAlertDialogScope = function(scope) {
  return scope;
}, ROOT_NAME = "AlertDialog", TRIGGER_NAME = "AlertDialogTrigger", NativeAlertDialogTriggerFrame = styled(View, {
  name: TRIGGER_NAME
...
var AlertDialogPortal = function(props) {
...
}), CONTENT_NAME = "AlertDialogContent", { Provider: AlertDialogContextProvider, useStyledContext: useAlertDialogContentContext } = createStyledContext({}, "AlertDialogContext"), AlertDialogContent = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var { scope, children, ...contentProps } = props, dialogScope = getAlertDialogScope(scope), contentRef = React.useRef(null), composedRefs = useComposedRefs(forwardedRef, contentRef), cancelRef = React.useRef(null);
  ...
  var { scope, ...cancelProps } = props, { cancelRef } = useAlertDialogContentContext(scope), ref = useComposedRefs(forwardedRef, cancelRef);
  return /* @__PURE__ */ _jsx(DialogClose, {
    scope: getAlertDialogScope(scope),
    ...cancelProps,
    ref
  ...
  var { scope, native, ...alertDialogProps } = props, dialogScope = getAlertDialogScope(scope), [open, setOpen] = useControllableState({
    prop: props.open,
